...
| `copper_s2_tabular_deep_kaggle.py` | **Next paste.** Stress grid (horizons 5/21/63 × step 26/13 × cost 4/8 bps) on headline `shortlist_graph_cot`. Per-arm masks. No GAT. `promote=false`. |
