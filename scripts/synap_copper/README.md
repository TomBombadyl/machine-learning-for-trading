...
| `copper_s2_tabular_focus_kaggle.py` | **Next paste (v1.1).** Shrunk 12 topologies, primary first, mid-job atomic memo + heartbeat + early `primary_gate` file. See `docs/synap/KAGGLE_LONG_RUN.md`. No GAT. |
